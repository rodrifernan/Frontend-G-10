...
export const OrderDetails = () => {
    ...
    const filterOrderbyNumberProduct = orderAll.filter(e=>e.orderNumber===parseInt(productId))
    // console.log(filterOrderbyNumberProduct[0]);

    const [data, setData] = useState(filterOrderbyNumberProduct[0])
        ...
        <div className='orderDetail__container'>
            ...
            <div className="orderDetail__header">
                ...
                <div className='orderDetail__container-item'>
                    ...
                    <div className='list__item'> {data.user.firstName} {data.user.lastName} </div>
                </div>
