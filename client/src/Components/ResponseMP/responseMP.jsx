...
const ResponseMP = () => {
         ...
         // console.log(getOrderAllEl?.orderBd?.orderNumber)
          let subTotal      = 0
          let totalPagar    = 0
          let descuentoItem = 0
                        ...
                        <div className="row">
                            ...
                            <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                ...
                                <div class="text-grey-m2">
                                    ...
                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Fecha:</span>{getOrderAllEl?.orderBd?.createdAt}</div>
...
const genPDF = async () => {
        ...
        doc.html(pdfjs, {
            callback: function(doc) {doc.save("OrdenCompra.pdf")},
            x: 10,
            y: 10
        });
