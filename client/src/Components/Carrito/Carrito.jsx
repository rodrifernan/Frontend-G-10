			...
			<div className="carrito__container">
				...
				<div className="bg-light mt-3 mx-3">
					...
					{Array.isArray(Parse) ? (
						...
						<div className=" text-center">
							<h3>
								Su carro de compras está vacio. Agregue algunos
								productos!
							</h3>
						</div>
					)}
				...
				<div className="mt-2 d-flex">
					...
					<div className="text-right col-6">
						<button
							onClick={() => handleOnCheckMP()} // chequear mercado pago
...
const getCheckoutMP = async () => {
	...
	await axios.get("http://localhost:3001/api/checkout").catch((err) => {
		console.log(err);
	});
};
