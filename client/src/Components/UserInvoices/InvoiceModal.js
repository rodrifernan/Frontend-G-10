...
export const InvoiceModal = ({ invoice, user }) => {
  return (
    <div
            ...
            >
              ...
              <div className='col-12 col-lg-12'>
                  ...
                  <div className='col-12'>
                    <div className='text-center text-150'>
                      ...
                      <span className='text-default-d3'>
                        Orden de Compa Nro.0000{invoice.invoiceNumber}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className='row text-600 text-white bgc-default-tp1 py-25'>
                  ...
                  <div className='d-none d-sm-block col-sm-3'>Descripción</div>
                  <div className='d-none d-sm-block col-sm-2'>Cantidad</div>
                  <div className='d-none d-sm-block col-sm-2'>
                    Precio Unitario
                  </div>
                  <div className='d-none d-sm-block col-sm-2'>Descuento</div>
                  ...
                  {invoice.orders.map((elem, index) => {
                    return (
                      <div className='row mb-2 mb-sm-0 py-25'>
                        ...
                        <div className='col-sm-3'>{elem.product.name}</div>
                ...
                <div className='row mt-3'>
                  <div className='col-12 col-sm-5 text-grey text-90 order-first order-sm-last'>
                    <div className='row my-2 align-items-center bgc-primary-l3 p-2'>
                      <div className='col-7 text-right'>Total Monto</div>
                      <div className='col-5'>
