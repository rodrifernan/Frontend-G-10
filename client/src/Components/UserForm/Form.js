...
import { userRegister, cleanUserResponse } from '../../redux/reducer/userPost';
...
export const Form = () => {
  ...
  useEffect(() => {
    ...
    if (userResponse.error) {
      ...
      userResponse.errors.forEach(error => {
        setFormErrors(state => ({ ...state, [error.param]: error.msg }));
      });
    }
  ...
  return (
    <div id='formUser'>
      ...
      <form onSubmit={handleOnSubmit} className='container' autoComplete='off'>
        <div className='row'>
          ...
          <div className='col-md-6'>
            <div className='input-group has-validation'>
              ...
              <input
                ...
                onChange={handleOnchangeActivity}
                className={
                  'form-control ' + (formErrors.password && 'is-invalid')
                }
          ...
          <div className='col-md-12'>
            <div className='input-group has-validation'>
              ...
              <input
                ...
                onChange={handleOnchangeActivity}
                className={
                  'form-control ' + (formErrors.userName && 'is-invalid')
                }
          ...
          <div className='col-md-6'>
            <div className='input-group has-validation'>
              ...
              <input
                ...
                onChange={handleOnchangeActivity}
                className={
                  'form-control ' + (formErrors.firstName && 'is-invalid')
                }
                placeholder='Nombres.'
              />
          ...
          <div className='col-md-6'>
            <div className='input-group has-validation'>
              ...
              <input
                ...
                onChange={handleOnchangeActivity}
                className={
                  'form-control ' + (formErrors.lastName && 'is-invalid')
                }
          ...
          <div className='col-md-6'>
            <div className='input-group has-validation'>
              ...
              <input
                ...
                onChange={handleOnchangeActivity}
                className={
                  'form-control ' + (formErrors.idPersonal && 'is-invalid')
                }
                placeholder='ID personal.'
                required
              />

              <div className='invalid-feedback'>{formErrors.idPersonal}</div>
            </div>
          </div>
        </div>
